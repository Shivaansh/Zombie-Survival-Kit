...
\item [\refstepcounter{mnum} \mthemnum \label{mCISD}:] Component-Items-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mCICSD}:] Component-Items-Consumable-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mCIESD}:] Component-Items-Equipment-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mMESD}:] Manager-Equipment-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mMHSD}:] Manager-Health-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mMISD}:] Manager-Inventory-Software-Decision Module
\item [\refstepcounter{mnum} \mthemnum \label{mOIBH}:] Object-Interactable-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mOIIBH}:] Object-Interactable-Itemstore-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mPPBH}:] Player-PickUpDropItems-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mUEBH}:] UI-Equipment-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mUESBH}:] UI-Equipment-Slot-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mUIBH}:] UI-Inventory-Behaviour-Hiding Module
\item [\refstepcounter{mnum} \mthemnum \label{mUISBH}:] UI-Inventory-Slot-Behaviour-Hiding Module
\end{description}
